...
class BladeTest extends TestCase
{
    ...
    public function testBasic()
    {
        ...
        $this->assertEquals('hello world', trim((string) $output));
    }
    ...
    public function testVariables()
    {
        ...
        $this->assertEquals('hello John Doe', trim((string) $output));
    }

    public function testNonBlade()
    {
        $output = $this->blade->make('plain');
        $this->assertEquals('{{ this is plain php }}', trim((string) $output));
    }
    ...
    public function testComposer()
    {
        ...
        $this->assertEquals('hello John Doe and Jane Doe', trim((string) $output));
    }
    ...
    public function testCreator()
    {
        ...
        $output = $this->blade->make('variables');
        $this->assertEquals('hello Jane Doe and John Doe and John Doe', trim((string) $output));
    }
    ...
    public function testDirective()
    {
        ...
        $this->assertEquals('Your birthday is August 19, 1989 12:00 am', trim((string) $output));
    }

    public function testIf()
    {
        $output = $this->blade->make('if', ['birthday' => new DateTime('1989/08/19')]);
        $this->assertEquals('Birthday August 19, 1989 12:00 am detected', trim((string) $output));
    }
    ...
    public function testAddNamespace()
    {
        ...
        $this->assertEquals('hello other world', trim((string) $output));
    }
    ...
    //     $output = $this->blade->make('other::basic');
    //     $this->assertEquals('hello another world', trim((string) $output));
    // }
    ...
    public function testOther()
    {
        ...
        $this->assertEquals((string) $output, $this->expected('other'));
    }
